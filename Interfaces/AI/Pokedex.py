...
class Pokedex(dict):
    ...
    def get_evolve_by_id(self, pokemon_id):
        for rarity in self.rarity:
            if pokemon_id in self.rarity[rarity]:
                return rarity

    def get_rarity_name_by_id(self, rarity_id):
        return ["Critter", "Common", "Uncommon", "Rare", "Very Rare", "Epic", "Legendary", "Mythic"][rarity_id]
