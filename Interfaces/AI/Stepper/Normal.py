...
class Normal(object):
    ...
    def get_google_path(self, coords):
        self.google_path = 'http://maps.googleapis.com/maps/api/staticmap?size=400x400&key={1}&path=enc:{0}'.format(encode_coords(coords), self.scanner_thread.config_xml.get("map", "google", "key", ""))
