...
_ITEM = _descriptor.Descriptor(
  name='Membership',
  full_name='POGOProtos.Inventory.Membership',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='item_id', full_name='POGOProtos.Inventory.Membership.item_id', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='count', full_name='POGOProtos.Inventory.Membership.count', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unseen', full_name='POGOProtos.Inventory.Membership.unseen', index=2,
...
DESCRIPTOR.message_types_by_name['Membership'] = _ITEM
...
Item = _reflection.GeneratedProtocolMessageType('Membership', (_message.Message,), dict(
  DESCRIPTOR = _ITEM,
  __module__ = 'POGOProtos.Inventory_pb2'
  # @@protoc_insertion_point(class_scope:POGOProtos.Inventory.Membership)
  ))
