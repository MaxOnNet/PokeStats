...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename="{0}/.log/worker.log".format(path), filemode='w', level=logging.INFO, format='%(asctime)s [%(module)15s] [%(levelname)7s] [%(threadName)3s] %(message)s')
